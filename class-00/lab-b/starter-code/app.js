...
// "this" is the object itself, this does not have a value. This will get a value when a new object is created. You also cant change the value of this, its not a variable.
// 2. What is "this" when joe.scopeArrow() is invoked?
// when you try to invoke this while using the arrow function instead of normally calling the function. You get undefined because the arrow function doesnt have a this. The arrow function only follows the normal variable look up rules.
// 3. Explain why "this" is different when an arrow function is used.
// It is different because the arrow function doesnt have a this in its look up rule.
